 ...
 * @author meshm
 */
public class OffersSearchPanel extends JPanel implements ActionListener{
    ...
    public OffersSearchPanel() {
        ...
        jlAddOffer = new JLabel("Search SpecialOffer ... !");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == Reset) {
            ...
            if (!jtfOfferId.getText().equals("")) {
                
                SpecialOffers off2 = new SpecialOffers();
                  
            if (Integer.parseInt(jtfOfferId.getText())>0)
            {
                
                
                jtfDes.setText(""+off2.searchOffers(Integer.parseInt(jtfOfferId.getText())));
